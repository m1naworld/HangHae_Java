...
public class CommentService {
    ...
    // 댓글 등록
    public CommentDto insertComment(Long postId, String comment, HttpServletRequest request) throws InvalidKeyException {
    ...
    // 댓글 수정
    @Transactional
    public CommentDto updateComment(Long commentId, String comment, HttpServletRequest request) throws InvalidKeyException {
    ...
    // 댓글 삭제
    @Transactional
    public String deleteComment(Long commentId, HttpServletRequest request) throws InvalidKeyException {
